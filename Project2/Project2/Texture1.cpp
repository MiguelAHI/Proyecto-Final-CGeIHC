...
/*	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_MIRRORED_REPEAT);// eje S paralelo a X, repetir sobre el eje pero rotando con forme a un centro //La textura sibre algo la repetiras tantas veces como sea necesario
...
*/
	...
	*/
	...
	glGenerateMipmap(GL_TEXTURE_2D);//EN ESTA LINEA ES EN DONDE SE CREA LA TEXTURA 
	/*}else{
...
{	//UnitTexture
	...
	glBindTexture(GL_TEXTURE_2D, textureID);//pARA INDICARLE A LA SUPERFICIE QUE TEXTURA VA A UTILIZAR
